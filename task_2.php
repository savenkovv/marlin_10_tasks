...
<?php
  $items = [
    [
      'title_1'=>'Privacy',
      'desc_1'=>'Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
...
<?php foreach ($items as $item): ?>
                            ...
                            <p class="mb-g">
                            <?php echo $item['desc_1'] ?>  
                            </p>
                            <h3><?php echo $item['title_2'] ?></h3>
                            <p>
                            <?php echo $item['desc_2'] ?>
                            </p>
<?php endforeach; ?>
                        </div>
                        </div>
