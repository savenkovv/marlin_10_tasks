...
<?php
	...
	[ 'banned'=>false,
		...
		'twitter_blank'=>'@myplaneticket',
		'contact'=>'https://wrapbootstrap.com/user/myorange',
		'contact_blank'=>'Contact Sunny'
	],
	[
    'banned'=>false,
		...
		'twitter_blank'=>'@atlantez',
		'contact'=>'https://wrapbootstrap.com/user/Walapa',
		'contact_blank'=>'Contact Jos'
	],
	[
    'banned'=>true,
		...
		'twitter_blank'=>'@lodev09',
		'contact'=>'https://wrapbootstrap.com/user/lodev09',
		'contact_blank'=>'Contact Jovanni'
	],
	[
    'banned'=>true,
		...
		'twitter_blank'=>'@sildur',
		'contact'=>'https://wrapbootstrap.com/user/sildur',
		'contact_blank'=>'Contact Roberto'
	]
];
?>
  ...
  <?php endif; ?>  
                              <img src="<?php echo $item['img']; ?>" alt="<?php echo $item['alt']; ?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="<?php echo $item['twitter']; ?>" class="text-info fs-sm" target="_blank"><?php echo $item['twitter_blank']; ?></a> -
                                    <a href="<?php echo $item['contact']; ?>" class="text-info fs-sm" target="_blank" title="<?php echo $item['contact_blank']; ?>"><i class="fal fa-envelope"></i></a>
                                </div>
														</div>
<?php endforeach; ?>
                        </div>
